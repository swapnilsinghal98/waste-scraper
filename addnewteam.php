<?php
	...
	$lemail = mysqli_real_escape_string($con,$_POST['leader_email']);
    $desc = mysqli_real_escape_string($con,$_POST['desc']);
    $password = mysqli_real_escape_string($con,$_POST['image']);
    
    $teamname = htmlspecialchars($teamname);
    $lemail = htmlspecialchars($lemail);
    $desc = htmlspecialchars($desc);
    $password = htmlspecialchars($password);
    if($teamname=='' || $lemail=='' || $desc=='' || $p==''){
        
        echo "<div style='color:red'><p>Input Fields cannot be Left Blank!!</p></div>";
            header('location: makeateam.php');
    }
